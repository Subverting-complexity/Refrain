...
.SYNOPSIS
    ...
    files. Refrain checks the icon, splash, favicon, and the three Android
    adaptive-icon layers. A missing or zero-byte asset fails the gate in
    both local and CI modes (there is no placeholder generator -- the
    remedy is to restore the real artwork in assets/images/).
#>
