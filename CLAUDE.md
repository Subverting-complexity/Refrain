...
| `docs/RELEASING.md`          | EAS auth, the automatic version bump, release-branch/outcome-tag tracking, and store-submission troubleshooting. Read before touching a deploy script or `tools/version-bump.mjs` / `tools/release-branch.mjs`. |
